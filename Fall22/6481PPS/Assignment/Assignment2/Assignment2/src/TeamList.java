...
public class TeamList {
    ...
    public void insertAtIndex(Team T,int index) throws NoSuchElementException
    {
        ...
        // the node needs to be inserted at and create the pointer chain as follows
            ...
            for (TeamNode itr = this.head; itr != null; itr = itr.getNextNode()) {
                if (index == next) {
                    TeamNode newNode = new TeamNode(T, itr.getNextNode());
    ...
    TeamNode sortedMerge(TeamNode  a, TeamNode b)
    {
    ...
    TeamNode mergeSort(TeamNode h)
    {
        ...
        TeamNode middle = getMiddle(h);
        TeamNode nextOfMiddle = middle.getNextNode();

        // set the next of middle node to null
        middle.setNextNode(null);

        // Apply mergeSort on left list
        TeamNode left = mergeSort(h);
    ...
    public static TeamNode getMiddle(TeamNode head)
    {
        if (head == null)
            return null;
